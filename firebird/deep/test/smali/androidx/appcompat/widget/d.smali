...
.method public constructor <init>(Landroidx/appcompat/widget/Toolbar;Z)V
    ...
    sget-object v1, Lb/b;->a:[I

    const v3, 0x7f030005

    const/4 v4, 0x0

    invoke-static {p1, v4, v1, v3, v0}, Lh/u0;->o(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lh/u0;

    move-result-object p1

    const/16 v1, 0xf

    invoke-virtual {p1, v1}, Lh/u0;->e(I)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    iput-object v3, p0, Landroidx/appcompat/widget/d;->p:Landroid/graphics/drawable/Drawable;

    if-eqz p2, :cond_e

    const/16 p2, 0x1b

    invoke-virtual {p1, p2}, Lh/u0;->l(I)Ljava/lang/CharSequence;
    ...
    .line 6
    invoke-virtual {p1, p2}, Lh/u0;->e(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/d;->y()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/d;->x()V

    :cond_5
    const/16 p2, 0xa

    .line 12
    invoke-virtual {p1, p2, v0}, Lh/u0;->h(II)I

    move-result p2

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/d;->u(I)V

    const/16 p2, 0x9

    invoke-virtual {p1, p2, v0}, Lh/u0;->j(II)I
    ...
    invoke-virtual {p1, p2, v0}, Lh/u0;->i(II)I
    ...
    invoke-virtual {p1, p2, v1}, Lh/u0;->c(II)I

    move-result p2

    const/4 v2, 0x3

    invoke-virtual {p1, v2, v1}, Lh/u0;->c(II)I
    ...
    iget-object v2, v2, Landroidx/appcompat/widget/Toolbar;->u:Lh/n0;

    invoke-virtual {v2, p2, v1}, Lh/n0;->a(II)V
    ...
    .line 25
    :cond_12
    invoke-virtual {p0}, Landroidx/appcompat/widget/d;->t()Landroid/content/Context;
    ...
    new-instance p2, Lh/v0;

    invoke-direct {p2, p0}, Lh/v0;-><init>(Landroidx/appcompat/widget/d;)V
...
.method public b(Landroid/view/Menu;Landroidx/appcompat/view/menu/i$a;)V
    ...
    .line 6
    iput-boolean v1, v0, Landroidx/appcompat/widget/a;->r:Z
    ...
    invoke-virtual {v0, p1, v2}, Landroidx/appcompat/widget/a;->j(Landroid/content/Context;Landroidx/appcompat/view/menu/e;)V
    ...
    .line 9
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/a;->h(Z)V
...
.method public c()Z
    ...
    .line 3
    iget-object v3, v0, Landroidx/appcompat/widget/a;->v:Landroidx/appcompat/widget/a$c;
...
.method public i(IJ)Le0/o;
    ...
    invoke-virtual {v0, p1, p2}, Le0/o;->e(Landroid/view/View;Le0/p;)V
...
.method public o(Landroidx/appcompat/widget/c;)V
    .locals 1

    iget-object p1, p0, Landroidx/appcompat/widget/d;->c:Landroid/view/View;
