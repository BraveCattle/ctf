...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/e;Landroid/view/View;IIZ)V
    ...
    new-instance p3, Lh/k0;

    const/4 p6, 0x0

    invoke-direct {p3, p1, p6, p4, p5}, Lh/k0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object p3, p0, Landroidx/appcompat/view/menu/k;->j:Lh/k0;
...
.method public a()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/k;->j:Lh/k0;
...
.method public f(Landroidx/appcompat/view/menu/l;)Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/k;->j:Lh/k0;

    .line 5
    iget v3, v2, Lh/i0;->g:I

    .line 6
    iget-boolean v4, v2, Lh/i0;->j:Z
    ...
    sget-object v6, Le0/m;->a:Ljava/util/WeakHashMap;
...
.method public i()V
    ...
    .line 2
    iget-object v0, v0, Lh/i0;->z:Landroid/widget/PopupWindow;
    ...
    .line 4
    iput-object p0, v0, Lh/i0;->q:Landroid/widget/AdapterView$OnItemClickListener;

    .line 5
    invoke-virtual {v0, v1}, Lh/i0;->s(Z)V
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/k;->j:Lh/k0;

    .line 6
    iput-object v0, v3, Lh/i0;->p:Landroid/view/View;

    .line 7
    iget v0, p0, Landroidx/appcompat/view/menu/k;->u:I

    .line 8
    iput v0, v3, Lh/i0;->m:I
    ...
    invoke-virtual {v0, v4}, Lh/i0;->r(I)V
    ...
    :goto_1
    iput-object v5, v0, Lh/i0;->x:Landroid/graphics/Rect;
    ...
    invoke-virtual {v0, v2}, Lh/i0;->o(Landroid/widget/ListAdapter;)V
...
.method public t(I)V
    ...
    .line 1
    iput p1, v0, Lh/i0;->h:I

    const/4 p1, 0x1

    iput-boolean p1, v0, Lh/i0;->j:Z
