...
void add_product(int choice){
	...
	switch(choice){
		case 0:
			...
			break;
		case 1:
			new_product->product_price=19;
			new_product->product_name="SLit2005";
			break;
		case 2:
			new_product->product_price=67;
			new_product->product_name="DgFinger";
			break;
		case 3:
			new_product->product_price=1579;
			new_product->product_name="FaceReco";
			break;
		case 4:
			new_product->product_price=2127;
			new_product->product_name="SRetinal";
			break;
		case 5:
			new_product->product_price=201;
			new_product->product_name="MotionX6";
			break;
		default:
			new_product->product_price=685;
